...
class GravaDadosAtracacao(StorageTask):
    ...
    def _execute(cls, **kwargs):
        ...
        # NOTE: Eduardo Luiz
        # Necessário buscar um método mais otimizado para isto
        # Da forma atual todos os dados acabam vindo para a aplicação
        rows = [tuple(x) for x in atracacao_df.toLocalIterator()]
