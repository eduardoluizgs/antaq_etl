...
class HttpHook(BaseHook):
    ...
    # definition
    def get_conn(self, headers=None, session=None):
        """
    ...
    def run(self, endpoint, data=None, headers=None, extra_options=None, session=None):
        """
        ...
        session = self.get_conn(headers, session=session)
